...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-09T16:21:20.606Z  
...
void solve() {
    ...
    // DP states initialized. -1e9 acts as negative infinity.
    int dp0 = 0;
    int dp1 = -1e9;
    int dp2 = -1e9;
    ...
    for (int i = 0; i < n; i++) {
        ...
        int next_dp0 = max({dp0, dp1, dp2});
        int next_dp1 = -1e9;
        int next_dp2 = -1e9;
        
        if (x == 3) {
            next_dp1 = 1 + max({dp0, dp1, dp2});
        } 
        else if (x == 2) {
            next_dp1 = 1 + max(dp0, dp1);
            next_dp2 = 1 + dp2;
        } 
        else if (x == 1) {
            next_dp2 = 1 + max(dp0, dp1);
        }
